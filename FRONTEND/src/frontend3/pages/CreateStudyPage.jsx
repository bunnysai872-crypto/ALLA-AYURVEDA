          ...
          <div className="f3-success-meta-box">
            <div className="f3-meta-item">
              ...
              <strong className="f3-meta-val f3-font-mono f3-text-accent">
                {createdStudy.study_id ? `${createdStudy.study_id} (#${createdStudy.id})` : `#${createdStudy.id ?? "Generated by Server"}`}
              </strong>
            </div>
            <div className="f3-meta-item">
            ...
            {(createdStudy.protocol_number || formData.protocol_number) && (
              <div className="f3-meta-item">
                <span className="f3-meta-label">PROTOCOL NUMBER</span>
                <span className="f3-meta-val f3-font-mono">
                  {createdStudy.protocol_number || formData.protocol_number}
                </span>
              </div>
            )}
